        ...
        <div class="page">
            <div class="weui_msg">
                <div class="weui_text_area">
                    <a id="url" href="#"><img id="img1" style="width:100%;text-align:center;border:1px solid #FF00FF;" src="" alt="" /></a>
                </div>
                ...
                <div style="width:100%;paddding:5px;border:1px solid #FF00FF;" >
                  <a id="url2" href="#"></a>
                </div>
