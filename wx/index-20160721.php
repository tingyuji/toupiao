                                    ...
                                    switch ($key) {
                                        case 'key1':
                                              ...
                                              if($diff>=10){
                                                    ...
                                                    if($status==3){
                                                      $msgType2 = "text";
                                                      $contentStr='您已经提交图片尚未回复完成，请回复完成';
                                                      $resultStr = sprintf($textTpl, $fromUsername, $toUsername, $time, $msgType2, $contentStr);
                                                      echo $resultStr; 
                                                    }
                                                    if($status==2){
                                        ...
                                        case 'key2':
                                                ...
                                                $redis->set($openid,$time);
                                                if($status>=2){
                                                  $items=$ordersClass->getAll16($openid);
                                                  $item=$items[0];
                                                  $pid=$item['pid'];
                                                  $title=$item['title'];
                                                ...
                                                if($type=='MP'){
                                                  ...
                                                  if($type!='MP'){
                                                    ...
                                                    $msgType2 = "news";
                                                    $resultStr = sprintf($newsTpl, $fromUsername, $toUsername, $time, $msgType2,$title,$message, $PicUrl,$url);  
                                                    echo $resultStr;
                                                  } 
                                        ...
                                        case 'key3':
                                            ...
                                            //$contentStr="由于平台任务太多，现在每天任务同步以及佣金、提成发放改到第二天凌晨进行，之前没有登录的，请点击菜单中的个人中心，绑定，完成绑定操作，避免不必要的损失。2016年5月15号，小时光";
                                            $contentStr="赚米吧不需要注册，关注后就可以做任务，为保证佣金发放及时，请在关注后，及时进行绑定，请回复'绑定'二字，进行绑定，绑定后当天佣金满一元，也就是做满九个任务，佣金在凌晨12点10分开始自动发放，佣金发放到微信零钱包。\n";
                                        ...
                                        case 'key4':
                                            ...
                                            $total=intval($total);
                                            if($total>8){
                                               $message.='恭喜您，您今天已圆满完成平台次日凌晨发放佣金的标准，未佣金发放成功，请及时进行绑定。';
                                            }
                                            if($total<9){
                                              $diff=9-$total;
                                              $message.="再接在励，还差$diff就可以完成次日发放佣金的基本指标。";
                                            }
                                        ...
                                        case 'login':
                                              ...
                                              if($diff>=10){
                                                $url='http://www.fangdan8.com/wx/login.php';
                              ...
                              switch ($keyword) {
                                ...
                                case '1':
                                              ...
                                              if($diff>=10){
                                                    ...
                                                    if($status==3){
                                                      $msgType2 = "text";
                                                      $contentStr='您已经提交图片尚未回复完成，请回复完成或者数字0';
                                                      $resultStr = sprintf($textTpl, $fromUsername, $toUsername, $time, $msgType2, $contentStr);
                                                      echo $resultStr; 
                                                    }
                                                    if($status==2){
                                ...
                                case '完成':
                                    ...
                                    switch ($status) {
                                        ...
                                        case '3':
                                          ...
                                          //$items=$ordersClass->getAll14($openid);

                                          $items=$ordersClass->getAll18($openid);
                                          $item=$items[0];  
                                          $id=$item['id'];
                                          $pid=$item['pid'];
                                          $title=$item['title'];
                                          ...
                                          $ordersClass->update10($id,$status);
                   ...
                   case "image":
                            ...
                            if($status>1){
                              ...
                              */
                              ...
                              $message="如果有多张截图请继续发送，如果已经发送完毕，请回复[完成]或者数字0。";
