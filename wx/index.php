                   ...
                   case "text":
                              ...
                              switch ($keyword) {
                                  ...
                                  case '绑定':
                                    ...
                                    $msgType = "text";
                                    $message="请点击下面绑定二字，完成绑定操作"."\n\n";
                                    $message.="----------------"."\n\n";
                                    $message.="<a href='".$url2."''>绑定</a>";
                                    $message.="\n\n";
                                              ...
                                              if($diff>=10){
                                                    ...
                                                    if($status<2){
                                                      ...
                                                      if($total==0){
                                                       ...
                                                       $contentStr.= "温馨提示"."\n\n";
                                                       $contentStr.= "--------------"."\n\n";
                                                       $contentStr.= "徒弟补贴正在核算过程中，请大家耐心等待"."\n\n";                                                       
                                                        $contentStr.= "--------------"."\n\n";
                                                        $contentStr.= "赚米吧六群 577820230"."\n\n";
                                              ...
                                              if($diff>=10){
                                                    ...
                                                    if($status<2){
                                                      ...
                                                      if($total==0){
                                                       ...
                                                       $contentStr.= "温馨提示"."\n\n";
                                                       $contentStr.= "--------------"."\n\n";
                                                       $contentStr.= "平台推出开心一笑功能，请回复数字5体验"."\n\n";                                                       
                                                        $contentStr.= "--------------"."\n\n";
                                                        $contentStr.= "赚米吧六群 577820230"."\n\n";
                                                        //$contentStr.= "由于紫萱昨天外出，之前佣金补发延迟一天发放"."\n";
                                                        $msgType = "text";
                                    ...
                                    switch ($status) {
                                        ...
                                        case '3':
                                            ...
                                            if($diff<=1200){
                                              ...
                                              $message.="--------------";
                                              $message.="\n\n";
                                              $message.="如需撤回当前任务，请在回复0之后及时回复数字9。";
                                              $resultStr = sprintf($textTpl, $fromUsername, $toUsername, $time, $msgType, $message);
                                              echo $resultStr;
                                ...
                                default:
                                    ...
                                    $message.="温馨提示："; 
                                    $message.=  "\n\n"; 
                                    $message.="徒弟补贴正在核算过程中，请耐心等待"."\n\n"; 
                                    $message.= "\n\n"; 

                                    $message.="核对规则："; 
                                    $message.=  "\n\n"; 
                                    $message.="徒弟能正常完成一个任务，并审核通过"."\n\n"; 
                                    $message.= "\n\n"; 
