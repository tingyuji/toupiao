...
class Wxapi {
     ...
     */
    public function pay($re_openid,$fee,$orderdate,$id,$db=null)
    {
        ...
        $wxHongBaoHelper->setParameter("desc", $orderdate.'*赚米吧*佣金发放');//备注信息
        

        //$wxHongBaoHelper->setParameter("desc", '21号，22号*赚米吧*佣金发放');//备注信息
        $wxHongBaoHelper->setParameter("spbill_create_ip", '59.56.110.142');//调用接口的机器 Ip 地址
