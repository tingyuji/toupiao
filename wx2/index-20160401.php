...
$wechatObj = new wechatCallbackapiTest("wxc6dc289a2b6c97d3","21ba41bd0458821694b94a83f46e94c3");
...
class wechatCallbackapiTest{
                            ...
                            case "click":
                                    ...
                                    switch ($key) {
                                        case 'key1':
                                            ...
                                            //$total=0;
                                            if($total==0){
                                              $url='http://www.renwenchao.com/wx/login.php';
                                              $url2='https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxc6dc289a2b6c97d3&redirect_uri='.$url.'&response_type=code&scope=snsapi_userinfo&state=STATE#wechat_redirect';
                                            ...
                                            if($total!=0){
                                              ...
                                              if($step<3){
                                                ...
                                                $PicUrl ='http://www.renwenchao.com/wx/logo/logo.png';
                                                $contentStr.=$url2;
                                                $msgType2 = "news";
                                                $resultStr = sprintf($newsTpl2, $fromUsername, $toUsername, $time, $msgType2, $PicUrl,$contentStr);
    ...
    如果无法完成该任务或者任务目标网页出错，可以回复【放弃】跳过该任务。';
                                                  ...
                                                  $price2=$item['price2'];
                                                  $img1=$item['img1'];
                                                  $imgUrl='http://www.renwenchao.com/toupiao/'.$img1;
                                ...
                                default:
                                  ...
                                  if($total!=0){
                                    ...
                                    if($step==3){
                                          ...
                                          $item=$items[0];
                                          $username=$item['username'];
                                          $contentStr="您已经登录，现在可以使用任务微信团队的功能了。";
