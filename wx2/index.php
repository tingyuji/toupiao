                ...
                switch($msgType){
                   ...
                   case "text":
                              ...
                              switch ($keyword) {
                                  ...
                                  $msgType = "text";
                                  $message="<a href='http://fangdan8.com/wxwx/index.php' >充值</a>";
                                ...
                                case '提现':
                                  $msgType = "text";
                                  //$message="<a href='http://www.fangdan8.com/wxhb/index.php' >提现</a>";
                                  $message="提现已步入正轨，请先到赚米吧公众号完成绑定操作。";
                                  $resultStr = sprintf($textTpl, $fromUsername, $toUsername, $time, $msgType, $message);
                                  echo $resultStr; 
                                  break;
                                ...
                                case '绑定':
                                  $msgType = "text";
                                  //$message="<a href='http://www.fangdan8.com/wxhb/index.php' >提现</a>";
                                  $message="绑定请移步到赚米吧公众号，在赚米吧公众号回复'绑定'二字，完成绑定操作";
                                  $resultStr = sprintf($textTpl, $fromUsername, $toUsername, $time, $msgType, $message);
                                  echo $resultStr; 
                                  break;
                                ...
                                case '去绑定':
                                  $msgType = "text";
                                  //$message="<a href='http://www.fangdan8.com/wxhb/index.php' >提现</a>";
                                  $message="去绑定请移步到赚米吧公众号，在赚米吧公众号回复'绑定'二字，按提示操作";
                                  $resultStr = sprintf($textTpl, $fromUsername, $toUsername, $time, $msgType, $message);
                                  echo $resultStr; 
                                  break;
