...
class wechatCallbackapiTest{
                            ...
                            case "click":
                                    ...
                                    switch ($key) {
                                        case 'key1':
                                            ...
                                            //$total=0;
                                            if($total==0){
                                              $url='http://www.toupiaovip.com/xiniu/login.php';
                                              $url2='https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx3edcd4111b348882&redirect_uri='.$url.'&response_type=code&scope=snsapi_userinfo&state=STATE#wechat_redirect';
                                            ...
                                            if($total!=0){
                                              ...
                                              if($step<3){
                                                ...
                                                $PicUrl ='http://www.toupiaovip.com/xiniu/logo/logo.png';
                                                $contentStr.=$url2;
                                                $msgType2 = "news";
                                                $resultStr = sprintf($newsTpl2, $fromUsername, $toUsername, $time, $msgType2, $PicUrl,$contentStr);
    ...
    如果无法完成该任务或者任务目标网页出错，可以回复【放弃】跳过该任务。';
                                                  ...
                                                  $price2=$item['price2'];
                                                  $img1=$item['img1'];
                                                  $imgUrl='http://www.easthinks.cn/'.$img1;
                                ...
                                default:
                                  ...
                                  if($total!=0){
                                    ...
                                    if($step==3){
                                          ...
                                          $item=$items[0];
                                          $username=$item['username'];
                                          $contentStr="您已经登录，现在可以使用任务犀牛的功能了。";
